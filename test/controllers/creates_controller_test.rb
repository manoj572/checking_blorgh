...
class CreatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create create" do
    assert_difference('Create.count') do
      post creates_url, params: { create: { email: @create.email, password: @create.password, username: @create.username } }
    end
  ...
  test "should update create" do
    patch create_url(@create), params: { create: { email: @create.email, password: @create.password, username: @create.username } }
